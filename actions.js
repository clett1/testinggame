...
var Actions = (function () {
  return {
    ...
    moveTo: function(event, params, actor) {
        ...
        //Change actor's position to the passed position
        actor.x = params.targetAbsoluteX;
        actor.y = params.targetAbsoluteY;        actor.parent.damageActor(actor);
    ...
    moveInc: function(event, params, actor) {
        ...
        actor.y = params.targetOffsetY;        actor.parent.damageActor(actor);
    ...
    sendMessage: function(event, params, actor) {
        this.sendMessage(params.actor, params.message)
    },
    /**
